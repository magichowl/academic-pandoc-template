...
参考文献引用示例{[}1{]}. All human beings are born free and equal in
dignity and rights. All human beings are born free and equal in dignity
and rights. All human beings are born free and equal in dignity and
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Eleanor Roosevelt hält die englische Version der Allgemeinen Erklärung der Menschenrechte (FDR Presidential Library \& Museum, CC BY 2.0 https://creativecommons.org/licenses/by/2.0, via Wikimedia Commons)}]{images/Eleanor_Roosevelt_and_Human_Rights_Declaration.jpeg}}
...
\CSLLeftMargin{{[}1{]} }%
\CSLRightInline{G. Brown, Ed., \emph{The {Universal} {Declaration} of
{Human} {Rights} in the 21st century, a living document in a changing
world}. Cambridge, {[}New York{]}: Open Book Publishers ; NYU Global
Institute for Advanced Study, 2016.}

\bibitem[\citeproctext]{ref-unitednations1948}
\CSLLeftMargin{{[}2{]} }%
\CSLRightInline{United Nations, \emph{Universal Declaration of Human
Rights}. 1948.}
